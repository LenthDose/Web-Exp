...
<%
      ...
      for (HashMap.Entry<String, Book> entry : bookCar.entrySet()){
        ...
        total += book.getNowPrice()*book.getBuyNum();
%>
          <tr>
            <td class="cart_td_1" id="select">
            ...
            <td class="cart_td_6" ><%=book.getNowPrice()*book.getBuyNum()%></td>
            <td class="cart_td_7">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="shopend"><br />商品总价（不含运费）：
              <label id="total" class="yellow"><%=total%></label>元
              <br>
