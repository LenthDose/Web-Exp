...
<% try{
    ...
    String password=request.getParameter("password"); //生成SMTP 的主机名称
    int n =from.indexOf('@'); int m=from.length() ;
    ...
    // 保证报头域同会话内容保持一致
     ...
     transport.close(); out.println("<script language='javascript'>alert(' 邮 件 已 发 送 ！ '); window.location.href='mail.html';</script>");
}catch(Exception e){
