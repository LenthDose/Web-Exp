...
<head>
    <title>修改图书界面</title>
    <link type="text/css" href="bookAdd.css" rel="stylesheet" />
</head>
<body>
<%
    ...
    <div class="content">
        ...
        <form name="frm2" action="doBookAlter.jsp" method="post" >
            ...
            <div class="box">
                ...
                <input type="date" name="pressDate" class="i-text" value="<%=book.getPress() %>">
            </div>
            <div class="box">
                <label class="i-label">*库存</label>
                <input type="text" name="bookNum" class="i-text" value="<%=book.getBuyNum() %>"/>
            </div>
            <div class="box">
